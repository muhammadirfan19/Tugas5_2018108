...
public class SteamAdapter extends
        RecyclerView.Adapter<SteamAdapter.SteamViewHolder> {
    String data1[], data2[], data3[];
    int images[];
    Context context;
    public SteamAdapter(Context ct, String s1[], String s2[],
                        String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
    ...
    @NonNull
    @Override
    public SteamAdapter.SteamViewHolder
    onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater =
                LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_steam,
                parent, false);
        return new SteamViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull
                                         SteamAdapter.SteamViewHolder holder, int position) {
    ...
    public class SteamViewHolder extends
